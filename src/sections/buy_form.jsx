...
import {
  ...
  backScreen,
  setNextText,
} from '../features/buy_form_screen_slice'
...
export default function BuyForm() {
  ...
  return (
    <div className={clsx('buy-form', { active: isFormVisible })}>
      <form
        className={clsx('form', { loading: isLoading })}
        onSubmit={(e) => {
          e.preventDefault()
        }}
      >
        ...
        <div className={clsx('content', { 'full-width': fullWithContent })}>
